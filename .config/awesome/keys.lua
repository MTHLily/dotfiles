...
keys.desktopbuttons = gears.table.join(awful.button({}, 1, function()
    ...
    if sidebar_hide then sidebar_hide() end
    -- Double tap
...
awful.button({}, 3, function() if app_drawer_show then app_drawer_show() end end),

    -- Middle button - Toggle dashboard
    awful.button({}, 2,
        function() if dashboard_show then dashboard_show() end end), -- Scrolling - Switch tags
    awful.button({}, 4, awful.tag.viewprev), awful.button({}, 5,
        awful.tag.viewnext), -- Side buttons - Control volume
    awful.button({}, 9, function() helpers.volume_control(5) end), awful.button(
        {}, 8, function() helpers.volume_control(-5) end) -- Side buttons - Minimize and restore minimized client
...
--         awful.client.focus.bydirection("right")
--     end, {description = "focus right", group = "client"}), -- Window switcher
--     awful.key({superkey}, "Tab",
--               function() window_switcher_show(awful.screen.focused()) end,
...
--               function(c) helpers.resize_dwim(client.focus, "down") end),
--                       awful.key({superkey, ctrlkey}, "Up", function(c)
--         helpers.resize_dwim(client.focus, "up")
--     end), awful.key({superkey, ctrlkey}, "Left",
--                     function(c) helpers.resize_dwim(client.focus, "left") end),
--                       awful.key({superkey, ctrlkey}, "Right", function(c)
--         helpers.resize_dwim(client.focus, "right")
--     end), awful.key({superkey, ctrlkey}, "j",
--                     function(c) helpers.resize_dwim(client.focus, "down") end),
--                       awful.key({superkey, ctrlkey}, "k", function(c)
--         helpers.resize_dwim(client.focus, "up")
--     end), awful.key({superkey, ctrlkey}, "h",
--                     function(c) helpers.resize_dwim(client.focus, "left") end),
...
--     awful.key({superkey, shiftkey}, "x", function() exit_screen_show() end,
...
--     end, {description = "rofi launcher", group = "launcher"}), -- Run
...
--     awful.key({altkey}, "F1", function() helpers.volume_control(0) end,
--               {description = "(un)mute volume", group = "volume"}),
--                       awful.key({altkey}, "F2",
--                                 function() helpers.volume_control(-5) end, {
--         description = "lower volume",
--         group = "volume"
--     }), awful.key({altkey}, "F3", function() helpers.volume_control(5) end,
...
--                                 function() microphone_overlay_toggle() end, {
...
--                                 function() apps.screenshot("selection") end, {
--         description = "select area to capture",
--         group = "screenshots"
--     }), awful.key({superkey, ctrlkey}, "c",
--                   function() apps.screenshot("clipboard") end, {
--         description = "select area to copy to clipboard",
--         group = "screenshots"
--     }),
--                       awful.key({superkey}, "Print",
--                                 function() apps.screenshot("browse") end, {
--         description = "browse screenshots",
--         group = "screenshots"
--     }), awful.key({superkey, shiftkey}, "Print",
--                   function() apps.screenshot("gimp") end, {
--         description = "edit most recent screenshot with gimp",
--         group = "screenshots"
--     }), -- Toggle tray visibility
--     awful.key({superkey}, "=", function() tray_toggle() end,
...
--         group = "other"
--     }), awful.key({superkey, shiftkey}, "F7",
--                   function() awful.spawn.with_shell("freeze -u firefox") end, {
...
--             local clients = awful.screen.focused().clients
--             for _, c in pairs(clients) do c.floating = false end
--         end)
--     end, {description = "set max layout", group = "tag"}), -- Tiling
...
--     end, {description = "set floating layout", group = "tag"}), -- Dashboard
--     awful.key({superkey}, "F1", function()
--         if dashboard_show then dashboard_show() end
--         -- rofi_show()
--     end, {description = "dashboard", group = "custom"}), -- App drawer
--     awful.key({superkey}, "a", function() app_drawer_show() end,
--               {description = "App drawer", group = "custom"}),

--     -- Pomodoro timer
--                       awful.key({superkey}, "slash", function()
--         awful.spawn.with_shell("pomodoro")
--     end, {description = "pomodoro", group = "launcher"}), -- Spawn file manager
...
--         awful.placement
--             .centered(c, {honor_workarea = true, honor_padding = true})
--         helpers.single_double_tap(nil, function()
...
--                                 function(c) decorations.cycle(c) end, {
...
--         local clients = awful.screen.focused().clients
--         for _, c in pairs(clients) do decorations.cycle(c) end
...
--     end, {description = "focus mode", group = "client"}), -- T for tiny window
...
--     end, {description = "normal mode", group = "client"}), -- Close client
...
--         if not layout_is_floating then awful.client.floating.toggle() end
--     end, {description = "toggle floating", group = "client"}), -- Set master
...
--                                 function(c) c.opacity = c.opacity - 0.1 end, {
...
--               {description = "toggle sticky", group = "client"}), -- Minimize
--     awful.key({superkey}, "n", function(c) c.minimized = true end,
--               {description = "minimize", group = "client"}), -- Maximize
--     awful.key({superkey}, "m", function(c) c.maximized = not c.maximized end,
...
-- Overwrite with personal keybindings
keys.globalkeys = require("keybindings.init")
...
local ntags = 10
for i = 1, ntags do
    keys.globalkeys = gears.table.join(keys.globalkeys, -- View tag only.
    awful.key({Superkey}, "#" .. i + 9, function()
        ...
        -- tag:view_only()
        -- end
    end, {description = "view tag #", group = "tag"}), -- Toggle tag display.
    awful.key({Superkey, Ctrlkey}, "#" .. i + 9, function()
        local screen = awful.screen.focused()
        local tag = screen.tags[i]
        if tag then awful.tag.viewtoggle(tag) end
    end, {description = "toggle tag #", group = "tag"}), -- Move client to tag.
    awful.key({Superkey, Shiftkey}, "#" .. i + 9, function()
        ...
        end, {description = "move all visible clients to tag #", group = "tag"}), -- Toggle tag on focused client.
