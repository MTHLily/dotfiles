...
local rules = { -- All clients will match this rule.
    ...
    }, {rule = {maximized = true}, properties = {border_width = 0}}, -- Titlebars
    {
    ...
    {
        rule_any = {class = {"persepolis", "kcalc", "megasync"}},
        properies = {floating = true}
    },
    {rule = {class = "discord"}, properties = {tag = awful.util.tagnames[7]}},
    {rule = {class = "kalendar"}, properties = {tag = awful.util.tagnames[6]}},
    {rule = {class = "Spotify"}, properties = {tag = awful.util.tagnames[9]}},
    {
        rule_any = {class = "firefox"},
        properties = {tag = awful.util.tagnames[1]}
    },
    {rule = {class = "Mailspring"}, properties = {tag = awful.util.tagnames[8]}}, -- Set applications to always map on the tag 1 on screen 1.
    ...
    {rule = {class = config.apps.mediaplayer}, properties = {maximized = true}},
    ...
    --    { rule = { class = "Vivaldi-snapshot" },
    --          properties = { callback = function (c) c.maximized = false end } },
    {rule = {class = "Xfce4-settings-manager"}, properties = {floating = false}}, -- Floating clients.
    {
        rule_any = {
            instance = {
            ...
            class = {
                ...
                "kcalc", "persepolis", "archlinux-logout", "Peek", "Skype",
                "System-config-printer.py", "Sxiv", "Unetbootin.elf", "Wpa_gui",
