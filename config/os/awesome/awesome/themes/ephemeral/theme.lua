...
theme.wallpaper =
    os.getenv("HOME") .. "/.config/awesome/themes/" .. theme_name ..
        "/wallpaper.jpg"
-- A blurred version of your wallpaper would be nice
theme.wallpaper_lock = os.getenv("HOME") .. "/.config/awesome/themes/" ..
                           theme_name .. "/wallpaper_lock.jpg"
...
theme.taglist_text_color_empty = {
    x.foreground .. "60", x.foreground .. "60", x.foreground .. "60",
    x.foreground .. "60", x.foreground .. "60", x.foreground .. "60",
    x.foreground .. "60", x.foreground .. "60", x.foreground .. "60",
    x.foreground .. "60"
}
...
theme.taglist_text_color_urgent = {
    x.color7, x.color7, x.color7, x.color7, x.color7, x.color7, x.color7,
    x.color7, x.color7, x.color7
}
