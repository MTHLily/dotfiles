...
(setq user-full-name "MTHLily"
      user-mail-address "tree.of.pyres@gmail.com")
...
(map!
 :leader
 :desc "Create new heading at current line"
 "C-c C--" #'outline-insert-heading
)
